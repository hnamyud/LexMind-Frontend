...
export default function Sidebar({ isOpen = false, onClose }: SidebarProps) {
    ...
    return (
        <>
            ...
            <nav className={`w-64 bg-sidebar border-r border-gray-800 flex flex-col h-full shrink-0 fixed md:relative z-50 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
                {/* Logo & Close Button */}
                <div className="p-6 flex items-center justify-between">
                    ...
                    <Link href="/" className="text-xl font-bold tracking-tight text-white">LexMind</Link>
                    </div>
                ...
                <div className="px-4 mb-2">
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium text-white bg-gray-800 rounded transition-colors hover:bg-gray-700"
                    >
                            ...
                            <div key={label}>
                                ...
                                <div className="space-y-0.5">
                                    {items.map((conv) => (
                                        <div
                                            key={conv.id}
                                            className={`group relative flex items-center rounded transition-all ${activeId === conv.id
                                                ? "bg-gray-700"
                    ...
                    {isAuthenticated && user ? (
                        <div ref={popoverRef} className="relative">
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-2 px-3 py-2 rounded transition-colors cursor-pointer select-none ${popoverOpen ? "bg-gray-700" : "bg-gray-800/60 hover:bg-gray-700/70"
                                    }`}
                            >
